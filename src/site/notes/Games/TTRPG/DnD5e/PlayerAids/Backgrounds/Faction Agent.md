---
{"dg-publish":true,"permalink":"/games/ttrpg/dn-d5e/player-aids/backgrounds/faction-agent/","tags":["TTRPG/DND/5e"],"noteIcon":""}
---
...
Use the tables for the [Acolyte](http://dnd5e.wikidot.com/background:acolyte) background as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity. (For instance, consider the words "faith" and "faction" to be interchangeable.)
